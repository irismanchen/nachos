...
// Routines internal to the machine simulation -- DO NOT call these 
    ...
    TranslationEntry* FindInPageTable(int virtaddr);
    int FIFOFindPos();
    void FIFOUpdateTLB(TranslationEntry* entry);
    int LRUFindPos();
    void LRUUpdateTLB(TranslationEntry* entry);
    //TranslationEntry* FindInPageTable1(int virtaddr);
    //bool FindInBuffer(int vp);
    //void SwapPage(int vp);
    int missnum=0;
    NoffHeader *noffH;
    OpenFile *executable;
    //void replace();
